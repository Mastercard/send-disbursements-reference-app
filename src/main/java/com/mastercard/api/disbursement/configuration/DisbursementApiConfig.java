package com.mastercard.api.disbursement.configuration;
 ...
 */
@Configuration
public class DisbursementApiConfig {
    ...
    /**
     * Creates an instance of DisbursementApi using the above defined apiClient
     * @param env Environment from which we pull property details, to pass along to apiClient()
     * @return Instance of DisbursementApi
     * @throws Exception
     */
    @Bean
    public DisbursementApi disbursementApi(Environment env) throws Exception {
        return new DisbursementApi(apiClient(env));
    }
